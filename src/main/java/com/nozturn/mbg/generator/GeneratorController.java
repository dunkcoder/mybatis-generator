...
import com.nozturn.mbg.db.DBConnector;
import com.nozturn.mbg.model.Columns;
import com.nozturn.mbg.model.DBType;
...
import com.nozturn.mbg.util.StringUtil;
...
public class GeneratorController {
    ...
    public GeneratorController() {
        ...
        String baseForder = PropertiesUtil.getProperty("baseForder");
    ...
    public List<Tables> getTablesList() throws Exception {
        ...
        String tableNames = PropertiesUtil.getProperty("tableNames");
        ...
        try {
            if (tableNames == null || "".equals(tableNames.trim())) {
                ...
                for (String tableName : tableNames.replaceAll(" ", "").split(",")) {
                    tablesList.add(new DBConnector().queryTableByTableName(tableName));
                }
            }
        } catch (Exception e) {
            throw e;
    ...
    private GenTables getGenTablesByTableName(Tables tables) throws ClassNotFoundException, SQLException {
        ...
        genTables.setModelPackage(PropertiesUtil.getProperty("modelPackage"));
        genTables.setMapperPackage(PropertiesUtil.getProperty("mapperPackage"));
        genTables.setMapperXmlPackage(PropertiesUtil.getProperty("mapperXmlPackage"));
    ...
    public String getMapperXmlPath(String basePath, String mapperXmlPackage, String className) {
        return basePath + "\\" + mapperXmlPackage.replace(".", "\\") + "\\" + StringUtil.toLowerCaseFristOne(className)
                + "-mapper.xml";
    }
